...
| [TTS-GPU-SCHEDULER.md](./TTS-GPU-SCHEDULER.md) | CosyVoice 3、IndexTTS2、ComfyUI 与语音评价的本机重型计算租约和模型生命周期 |
| [SPEECH-EVALUATION.md](./SPEECH-EVALUATION.md) | AI 语音评价、严格串行工具链与本机重型计算租约 |
