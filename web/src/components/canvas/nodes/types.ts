...
export const workflowOutputKind = (category?: string): 'image' | 'video' | 'audio' =>
  category === 'txt2audio' ? 'audio' : category === 'txt2vid' || category === 'img2vid' || category === 'reference' || category === 'vid2vid' ? 'video' : 'image';
