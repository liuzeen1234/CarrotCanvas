...
export default function TtsNode(props: NodeProps) {
  ...
  return <div className={`canvas-node${props.selected ? ' selected' : ''}`}>
    ...
    <div className="canvas-node__header"><span className="canvas-node__type" style={{ background: '#eb2f96' }}>AI 配音</span><span className="canvas-node__bind">{data.provider === 'cosyvoice3' ? 'CosyVoice 3' : data.provider === 'indextts2' ? 'IndexTTS2' : 'Qwen3-TTS'}</span>
