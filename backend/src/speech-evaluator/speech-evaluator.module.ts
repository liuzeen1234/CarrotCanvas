...
@Module({ imports: [TypeOrmModule.forFeature([SpeechEvaluationItem]), AssetsModule, CanvasModule, RunsModule], controllers: [SpeechEvaluatorController], providers: [SpeechEvaluatorService] })
